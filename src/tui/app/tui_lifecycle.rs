...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            total_cost: 0.0,
            last_turn_cost_delta: 0.0,
            last_turn_cost_at: None,
            ...
            pending_open_model_picker_on_refresh: false,
            ...
            client_core_state: jcode_client_core::ClientCoreState::default(),
            ...
            pending_task_model_restore: None,
            ...
            sidebar: jcode_tui_sidebar::Sidebar::new(),
            usage_report_refreshing: false,
            usage_report_silent: false,
